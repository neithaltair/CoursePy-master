...
print("==================MODELO FURGONETA======================")
#Le agregams la marca y el modelo a la camioneta
miFurgoneta = Furgoneta("Genezzy", "Altair")

#El metodo de herencia encender se utiliza para encender la furgoneta
miFurgoneta.encender()

#Observamos el esstado de la camioneta 
miFurgoneta.estado()

#A el metodo carga le damos True para indicar que la furgoneta esta cargada
...
print("======================MODELO MOTO======================")
#instanciamos mi moto de moto y agregamos la marca y el modelo
miMoto = Moto("Honda","CBR")

#Llamamos a el metodo para que haga caballito
miMoto.caballito()

#imprimimos el estado de la moto con uso de herencia 
miMoto.estado()
